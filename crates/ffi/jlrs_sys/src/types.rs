...
pub type jlrs_try_trampoline_t = unsafe extern "C" fn(callback: *mut c_void, out: *mut c_void);

pub type jlrs_catch_trampoline_t = unsafe extern "C" fn(callback: *mut c_void, out: *mut c_void);
