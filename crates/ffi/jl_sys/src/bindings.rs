...
pub mod functions {
    ...
    unsafe extern "C" {
        ...
        pub fn jl_gc_set_cb_pre_gc(cb: unsafe extern "C" fn(std::ffi::c_int) -> (), enable: std::ffi::c_int);
        pub fn jl_gc_set_cb_post_gc(cb: unsafe extern "C" fn(std::ffi::c_int) -> (), enable: std::ffi::c_int);
