...
`jlrs = {version = "0.18.0-beta.0", features = ["sync-rt", "julia-1-8"]}`

`jlrs = {version = "0.18.0-beta.0", features = ["tokio-rt", "julia-1-8"]}`

`jlrs = {version = "0.18.0-beta.0", features = ["async-std-rt", "julia-1-8"]}`
