#![allow(deref_nullptr)]
/* generated from Julia version 1.8.0-rc1 */
...
fn bindgen_test_layout__jl_code_instance_t() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_jl_code_instance_t>())).ipo_purity_bits as *const _ as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_jl_code_instance_t>())).purity_bits as *const _ as usize },
        60usize,
        concat!(
            "Offset of field: ",
            stringify!(_jl_code_instance_t),
