/* generated from Julia version 1.6.0 */
...
pub const jlrs_result_tag_t_JLRS_RESULT_ARRAY: jlrs_result_tag_t = 2;
pub const jlrs_result_tag_t_JLRS_RESULT_SVEC: jlrs_result_tag_t = 3;
pub const jlrs_result_tag_t_JLRS_RESULT_TVAR: jlrs_result_tag_t = 4;
pub const jlrs_result_tag_t_JLRS_RESULT_INT: jlrs_result_tag_t = 5;
pub const jlrs_result_tag_t_JLRS_RESULT_ERR: jlrs_result_tag_t = 6;
...
#[doc = " the union field contains. If the flag is `JLRS_RESULT_VOID` `value_data` is set to a null"]
#[doc = " pointer, if it's `JLRS_RESULT_ERR` `value_data` is set to the pointer to the exception."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct jlrs_result_t {
    pub flag: jlrs_result_tag_t,
    pub __bindgen_anon_1: jlrs_result_t__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union jlrs_result_t__bindgen_ty_1 {
    pub value_data: *mut jl_value_t,
    pub array_data: *mut jl_array_t,
    pub svec_data: *mut jl_svec_t,
    pub tvar_data: *mut jl_tvar_t,
    pub int_data: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_jlrs_result_t__bindgen_ty_1() {
    assert_eq!(
        ::std::mem::size_of::<jlrs_result_t__bindgen_ty_1>(),
        8usize,
        concat!("Size of: ", stringify!(jlrs_result_t__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<jlrs_result_t__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(jlrs_result_t__bindgen_ty_1))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<jlrs_result_t__bindgen_ty_1>())).value_data as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(jlrs_result_t__bindgen_ty_1),
            "::",
            stringify!(value_data)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<jlrs_result_t__bindgen_ty_1>())).array_data as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<jlrs_result_t__bindgen_ty_1>())).svec_data as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<jlrs_result_t__bindgen_ty_1>())).tvar_data as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<jlrs_result_t__bindgen_ty_1>())).int_data as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn jlrs_compute_fieldtypes(
        st: *mut jl_datatype_t,
        stack: *mut ::std::os::raw::c_void,
    ) -> jlrs_result_t;
}
extern "C" {
    pub fn jlrs_field_index(
        t: *mut jl_datatype_t,
        fld: *mut jl_sym_t,
        err: ::std::os::raw::c_int,
    ) -> jlrs_result_t;
...
extern "C" {
    pub fn jlrs_get_nth_field(v: *mut jl_value_t, i: usize) -> jlrs_result_t;
}
extern "C" {
