/* generated from Julia version 1.5.2 */
...
pub const IOS_BUFSIZE: u32 = 32768;
...
pub const JL_OPTIONS_WARN_SCOPE_OFF: u32 = 0;
pub const JL_OPTIONS_WARN_SCOPE_ON: u32 = 1;
...
pub const JULIA_VERSION_STRING: &'static [u8; 6usize] = b"1.5.2\0";
pub const JULIA_VERSION_MAJOR: u32 = 1;
pub const JULIA_VERSION_MINOR: u32 = 5;
pub const JULIA_VERSION_PATCH: u32 = 2;
...
extern "C" {
    pub fn u8_offset(str_: *const ::std::os::raw::c_char, charnum: usize) -> usize;
}
extern "C" {
    pub fn u8_charnum(str_: *const ::std::os::raw::c_char, offset: usize) -> usize;
}
extern "C" {
...
extern "C" {
    pub fn u8_isvalid(str_: *const ::std::os::raw::c_char, length: usize) -> ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct stat {
...
pub type bufmode_t = ::std::os::raw::c_uint;
...
pub type bufstate_t = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ios_t {
...
extern "C" {
    pub fn ios_close(s: *mut ios_t) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn ios_str(s: *mut ios_t, str_: *mut ::std::os::raw::c_char) -> *mut ios_t;
}
extern "C" {
...
extern "C" {
    pub fn jl_isa_compileable_sig(
        type_: *mut jl_tupletype_t,
        definition: *mut jl_method_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn jl_symbol_lookup(str_: *const ::std::os::raw::c_char) -> *mut jl_sym_t;
}
extern "C" {
...
extern "C" {
    pub fn jl_tagged_gensym(str_: *const ::std::os::raw::c_char, len: i32) -> *mut jl_sym_t;
}
extern "C" {
...
pub type jl_vararg_kind_t = ::std::os::raw::c_uint;
extern "C" {
...
extern "C" {
    pub fn jl_cstr_to_string(str_: *const ::std::os::raw::c_char) -> *mut jl_value_t;
}
extern "C" {
...
extern "C" {
    pub fn jl_set_module_optlevel(self_: *mut jl_module_t, lvl: ::std::os::raw::c_int);
}
extern "C" {
    pub fn jl_get_module_optlevel(m: *mut jl_module_t) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn jl_table_peek_bp(a: *mut jl_array_t, key: *mut jl_value_t) -> *mut *mut jl_value_t;
}
extern "C" {
...
extern "C" {
    pub fn jl_error(str_: *const ::std::os::raw::c_char);
}
extern "C" {
...
pub type JL_IMAGE_SEARCH = ::std::os::raw::c_uint;
extern "C" {
...
extern "C" {
    pub fn jl_create_system_image(arg1: *mut ::std::os::raw::c_void) -> *mut ios_t;
}
extern "C" {
...
extern "C" {
    pub fn jl_expand_with_loc_warn(
        expr: *mut jl_value_t,
        inmodule: *mut jl_module_t,
        file: *const ::std::os::raw::c_char,
        line: ::std::os::raw::c_int,
...
pub type JL_RTLD_CONSTANT = ::std::os::raw::c_uint;
...
extern "C" {
    pub fn jl_compress_ir(m: *mut jl_method_t, code: *mut jl_code_info_t) -> *mut jl_array_t;
}
extern "C" {
    pub fn jl_uncompress_ir(
        m: *mut jl_method_t,
...
extern "C" {
    pub fn jl_ir_flag_inferred(data: *mut jl_array_t) -> u8;
}
extern "C" {
    pub fn jl_ir_flag_inlineable(data: *mut jl_array_t) -> u8;
}
extern "C" {
    pub fn jl_ir_flag_pure(data: *mut jl_array_t) -> u8;
}
extern "C" {
    pub fn jl_ir_nslots(data: *mut jl_array_t) -> isize;
}
extern "C" {
    pub fn jl_ir_slotflag(data: *mut jl_array_t, i: usize) -> u8;
}
extern "C" {
...
extern "C" {
    pub fn jl_uv_puts(stream: *mut uv_stream_t, str_: *const ::std::os::raw::c_char, n: usize);
}
extern "C" {
    pub fn jl_printf(
        s: *mut uv_stream_t,
...
extern "C" {
    pub fn jl_safe_printf(str_: *const ::std::os::raw::c_char, ...);
}
extern "C" {
