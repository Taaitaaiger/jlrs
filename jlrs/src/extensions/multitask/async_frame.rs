use crate::memory::{
    mode::Async,
    stack::StackPage,
    traits::{frame::Frame, root_pending::RootPending},
};
use crate::{
    ...
    memory::{
        ...
        traits::mode::private::Mode,
    },
    private::Private,
    wrappers::ptr::value::Value,
};
use crate::{memory::traits::frame::private, wrappers::ptr::private::Wrapper as _};
use futures::Future;
...
/// with [`Value::call_async`]. An `AsyncGcFrame` is available by implementing the `AsyncTask`
