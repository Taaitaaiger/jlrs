...
/// See [`parking_lot::RawMutex`] for more information.
pub struct RawGcSafeMutex {
    inner: RawMutex,
}

unsafe impl lock_api::RawMutex for RawGcSafeMutex {
    const INIT: Self = RawGcSafeMutex {
        inner: RawMutex::INIT,
    };
...
unsafe impl lock_api::RawMutexFair for RawGcSafeMutex {
    #[inline]
...
unsafe impl lock_api::RawMutexTimed for RawGcSafeMutex {
