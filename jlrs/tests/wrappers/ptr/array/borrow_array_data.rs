...
mod tests {
    ...
    fn borrow_nested() {
        JULIA.with(|j| {
            ...
            jlrs.scope_with_capacity(1, |global, mut frame| unsafe {
                ...
                frame.scope_with_capacity(4, |mut frame| {
    ...
    fn unrestricted_array_borrow() {
        JULIA.with(|j| {
            ...
            jlrs.scope_with_capacity(2, |_, mut frame| {
                unsafe {
                    let arr_val =
    ...
    fn value_data_mut() {
        JULIA.with(|j| {
            ...
            jlrs.scope_with_capacity(3, |global, mut frame| {
                unsafe {
    ...
    fn unrestricted_value_data_mut() {
        JULIA.with(|j| {
            ...
            jlrs.scope_with_capacity(6, |global, mut frame| {
                unsafe {
                    let submod = Module::main(global)
                        .submodule_ref("JlrsTests")?
                        .wrapper_unchecked();
