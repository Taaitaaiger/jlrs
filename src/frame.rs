...
//! [`Runtime::frame`] or [`Runtime::dynamic_frame`]. The latter is used by data that is only
...
use crate::memory::{Dynamic, FrameIdx, StackView, Static};
...
/// You get access to a `StaticFrame` by calling [`Runtime::frame`] or [`Frame::frame`], most of
...
/// [`Runtime::dynamic_frame`] or [`Frame::dynamic_frame`], most of
/// their functionality is defined in the [`Frame`] trait.
///
/// [`value`]: ../value/index.html
/// [`Runtime::dynamic_frame`]: ../struct.Runtime.html#method.dynamic_frame
